...
export const GenerateFunFactResponseSchema = z.object({
  ...
  /** Name of the item the fun fact is about; null when generic. */
  item_name: z.string().nullable(),
  item_id: z.uuid().nullable(),
  /** true when the response was served from daily_kitchen_cache. */
  cached: z.boolean(),
})
...
export const RagQueryResponseSchema = z.object({
  /** Concatenated context string passed into the Gemini prompt. */
  context: z.string(),
  chunks: z.array(
    z.object({
      id: z.uuid(),
